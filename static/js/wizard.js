(() => {
  ...
  const definitions = {
    users: [
      ...
      { title: 'Segurança', description: 'Credenciais e segundo fator', fields: ['password1', 'password2', 'new_password', 'password', 'is_active', 'must_change_password', 'required_actions', 'reset_mfa'] },
