...
- Validação visual dos requisitos de senha (lista de regras que acende conforme são atendidas, e indicador de senhas coincidindo) na etapa de definir nova senha da recuperação — mesmo componente já usado em "Alterar minha senha" e na troca obrigatória.
